...
function createGalaxy() {
    ...
    for (let i = 0; i < parameters.count; i++) {
        ...
        // ...rest of galaxy generation code...
    }
    ...
    // ...gradient and particleTexture creation...
...
nipplejs.create({
    ...
    if (data.vector && shipMove) {
        // ...joystick logic...
    }
});

renderer.domElement.addEventListener('touchstart', (e) => {
    const joystickTouch = Array.from(e.changedTouches)
        .some(t => t.target.closest('#joystick-zone'));
