...
const planets = [];
const planetData = [
    { name: 'Xylos', radius: 1, orbit: 20, speed: 0.00015, startAngle: 0 },
    { name: 'Cygnus X-1a', radius: 1.5, orbit: 35, speed: 0.00009, startAngle: Math.PI / 3 },
    { name: 'Veridia', radius: 1.2, orbit: 50, speed: 0.00006, startAngle: Math.PI * 2 / 3 },
    { name: 'Klendathu', radius: 0.8, orbit: 65, speed: 0.00012, startAngle: Math.PI },
    { name: 'Terminus', radius: 2, orbit: 80, speed: 0.00003, startAngle: Math.PI * 4 / 3 },
    { name: 'Helion Prime', radius: 1.8, orbit: 95, speed: 0.00004, startAngle: Math.PI * 5 / 3 }
];
...
function animate() {
    ...
    planets.forEach(planet => {
        const targetAngle = planet.startAngle + elapsedTime * planet.speed;
        if (!planet.isPaused) {
            planet.currentAngle = THREE.MathUtils.lerp(planet.currentAngle, targetAngle, 0.05);
        }
        planet.pivot.rotation.y = planet.currentAngle;
