...
const planets = [];
const planetData = [
    { name: 'Xylos', radius: 1, orbit: 20, speed: 0.005 },
    { name: 'Cygnus X-1a', radius: 1.5, orbit: 35, speed: 0.003 },
    { name: 'Veridia', radius: 1.2, orbit: 50, speed: 0.002 },
    { name: 'Klendathu', radius: 0.8, orbit: 65, speed: 0.004 },
    { name: 'Terminus', radius: 2, orbit: 80, speed: 0.001 },
    { name: 'Helion Prime', radius: 1.8, orbit: 95, speed: 0.0015 }
];
