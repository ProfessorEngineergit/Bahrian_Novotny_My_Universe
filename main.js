...
function animate() {
    ...
    pacingCircle.material.opacity = 0.6 + pulse * 0.4;

    planets.forEach(planet => {
        planet.boundaryCircle.material.opacity = 0.6 + pulse * 0.4;
    ...
    if (ship) {
        ...
        const circleCurrentRadius = pacingCircle.geometry.parameters.radius; // Torus geometry has 'radius'
